            ...
            try:
                ...
                for box in results.boxes:
                    ...
                    if conf > self.confidence_threshold:
                        ...
                        if label in self.cart and label not in detected_in_frame and not self.camera_reconnecting:  # MODIFIED
                            print(
                                f"Detected: {label}, Cart before removal: {self.cart}, camera_reconnecting: {self.camera_reconnecting}")
