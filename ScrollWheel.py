...
class SodaSelector(tk.Tk):
    def __init__(self):
        ...
        self.camera_frame = tk.Label(self.scrollable_frame, bg="black")
        self.camera_frame.pack(pady=10)
        self.current_image = None

        self.label_text = tk.StringVar()
        self.label = tk.Label(self.scrollable_frame, textvariable=self.label_text, font=("Helvetica", 14), bg="white")
        ...
        self.start_robot_button = tk.Button(self.scrollable_frame, text="Start Robot Vision", font=("Helvetica", 14), command=self.toggle_detection)
        self.start_robot_button.pack(pady=15)

        self.cart_button = tk.Button(self.scrollable_frame, text="View Cart", font=("Helvetica", 12), command=self.view_cart_popup)
    ...
    def create_circle_button(self, parent, soda_name, color):
        ...
        canvas.create_arc(0, 0, 90, 90, start=45, extent=90, style='arc', outline='white', width=1)
